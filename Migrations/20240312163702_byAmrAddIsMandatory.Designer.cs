...
namespace Tenor.Migrations
{
    ...
    [Migration("20240312163702_byAmrAddIsMandatory")]
    partial class byAmrAddIsMandatory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tenor.Models.DeviceLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tenor.Models.Tree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tenor.Models.Tree", b =>
                {
                    b.HasOne("Tenor.Models.DeviceLevel", "DeviceLevel")
                        .WithMany()
                        .HasForeignKey("DeviceLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tenor.Models.Tree", "Parent")
                        .WithMany("Childs")
                        .HasForeignKey("ParentId");

                    b.Navigation("DeviceLevel");
